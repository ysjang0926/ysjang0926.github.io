...
이번 글은 내용이 조금 길어질 것 같아 두 번으로 나누어서 포스팅하도록 하겠습니다.
...
해당 [Kernel](https://www.kaggle.com/ysjang0926/eda-911-calls-kor)로 들어가시면, 사각형 상자에 **마우스를 올려** 놓으면 **상관계수**를 확인하실 수 있고 사각형 상자를 **클릭**하면 이에 따른 **산점도**를 볼 수 있습니다.
